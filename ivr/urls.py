...
from .views import Calls, ServiceSelection, EnterAccountNumber, ObtainUserDeposit, GetLastWithdraw,GetAccountBalance
...
urlpatterns = [
    ...
    path('call/last_withdrawal/', GetLastWithdraw.as_view(), name='last_withdraw'),
